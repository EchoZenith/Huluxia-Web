        ...
        console.log(data);
            switch(data.status){
                case 1:
                    ...
                    $("#nick").text(nick);
                    $("#avatar").attr("src",avatar).click(function(){
                        window.location.href="../userinfo/?origin=空间/&user_id="+user_id;
                    });
                    $("#signature").show().text(signature);
                    $("#following").text(followingCount).parent().click(function(){
                        window.location.href = "../user_follow/?type=1&user_id="+user_id;
                    });
                    $("#follower").text(followerCount).parent().click(function(){
                ...
                case 0:
                    $("#nick").text("登录");
                    $("#avatar,#follow,#post,#favorite").click(function(){
